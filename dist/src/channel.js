...
function buildOutboundMessageId() {
...
export const omelinkPlugin = createChatChannelPlugin({
    base: {
        ...
        messaging: {
            ...
            normalizeTarget,
            targetResolver: {
                looksLikeId: (id) => normalizeTarget(id) !== undefined,
                hint: ""
            },
        ...
        gateway: {
            startAccount: async (ctx) => {
                ...
                ctx.log?.info?.(`Starting OMELINK channel (account: ${accountId}, path: ${config.webhookPath})`);
